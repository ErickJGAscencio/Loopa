...
export function HabitInfoCard({ habit, setModalVisible, setEditModalVisible, setCurrentHabit }: HabitInfoCardProps) {
            ...
            <View style={{
              ...
              >
                <View style={{ width: 25, alignItems: 'center' }}>
                  <FontAwesome5 name="edit" size={15} color="#1e1e1e" iconStyle="solid" />
                </View>
